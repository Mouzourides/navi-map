...
public class KmlParserTest extends ActivityTestCase {
    ...
    public void testInlineStyle() throws Exception {
        XmlPullParser parser = createParser(com.google.maps.androidMapUtility.test.R.raw.inline_style);
    ...
    public void testContainerHeirarchy() throws Exception {
        XmlPullParser parser = createParser(com.google.maps.androidMapUtility.test.R.raw.document_nest);
        KmlParser mParser = new KmlParser(parser);
        mParser.parseKml();
    ...
    public void testPlacemarkParsing() throws Exception {
        XmlPullParser parser = createParser(com.google.maps.androidMapUtility.test.R.raw.unsupported);
        KmlParser mParser = new KmlParser(parser);
        mParser.parseKml();
